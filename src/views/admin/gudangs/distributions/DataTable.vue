<template>
  <BaseList :items="data" empty-icon="ShoppingCart" empty-title="Belum Ada Distribusi"
    empty-description="Belum ada Distribusi Barang yang tersedia. Klik tombol 'Tambah Distribusi' untuk membuat transaksi baru.">
    <template #item="{ item }">
      <div
            ...
            <div class="flex justify-between items-center mt-2">
              <div class="flex gap-x-4 items-center text-gray-500 dark:text-gray-400">
                <div class="flex space-x-1 items-center">
                  ...
                  <div class="text-base">{{ item.reference_no || `INV-${item.id}` }}</div>
                </div>
