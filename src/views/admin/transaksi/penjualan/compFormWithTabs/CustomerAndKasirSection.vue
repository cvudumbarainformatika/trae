  ...
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4">
    ...
    <div class="mb-4 flex items-center gap-4 justify-center">
      <div
        ...
        <label
          :class="['px-4 py-2 cursor-pointer select-none transition-colors', store.isiTab.category === 'umum' ? 'bg-white dark:bg-gray-900 text-blue-600 dark:text-blue-400 font-semibold shadow' : 'text-gray-700 dark:text-gray-200']">
          <input type="radio" v-model="store.isiTab.category" value="umum" class="hidden" />
          Umum
        </label>
        <label
          :class="['px-4 py-2 cursor-pointer select-none transition-colors', store.isiTab.category === 'pelanggan' ? 'bg-white dark:bg-gray-900 text-blue-600 dark:text-blue-400 font-semibold shadow' : 'text-gray-700 dark:text-gray-200']">
