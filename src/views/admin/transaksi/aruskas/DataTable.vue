<template>
  <BaseList :items="data" empty-icon="ShoppingCart" empty-title="Belum Ada Transaksi Arus Kas"
    empty-description="Belum ada transaksi Arus Kas Dari Kasir. Klik tombol 'Arus Kas' untuk membuat transaksi baru.">
    <template #item="{ item }">
      <div
