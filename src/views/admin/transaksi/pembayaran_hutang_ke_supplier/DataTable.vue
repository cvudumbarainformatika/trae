<template>
  <BaseList :items="data" empty-icon="ShoppingCart" empty-title="Belum Ada Pembayaran Hutang"
    empty-description="Belum ada transaksi Pembayaran Hutang yang tersedia. Klik tombol 'Tambah Bayar Hutang' untuk membuat transaksi baru.">
    <template #item="{ item }">
      <div
