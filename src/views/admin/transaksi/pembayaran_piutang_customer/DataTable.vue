<template>
  <BaseList :items="data" empty-icon="ShoppingCart" empty-title="Belum Ada Piutang Dibayar"
    empty-description="Belum ada transaksi Pembayaran Piutang Dari Customer. Klik tombol 'Piutang dibayar' untuk membuat transaksi baru.">
    <template #item="{ item }">
      <div
