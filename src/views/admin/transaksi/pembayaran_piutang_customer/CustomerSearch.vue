<template>
  <div class="">
    <SearchDropdown ref="searchRef" id="supplier-search" v-model="searchQuery" placeholder="Cari Invoice / Supplier..."
      ...
      not-found-text="Data Penjualan tidak ditemukan" not-found-subtext="Coba kata kunci lain" :show-add-button="false"
      api-url="/api/v1/pembayaran-piutang/search" api-response-path="data.data" :api-params="{ per_page: 10 }"
