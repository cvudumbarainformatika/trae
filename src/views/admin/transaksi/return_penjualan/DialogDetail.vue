<template>
  <BaseDialog title="Detail Return Penjualan" max-width="5xl" @close="closeDialog" @show="handleShow">
    <div
    ...
    <span class="text-xs px-2 py-0.5 rounded-full" :class="{
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="p-4 bg-white dark:bg-secondary-800 rounded-xl shadow-sm">
          <h3 class="text-sm font-medium text-secondary-500 dark:text-secondary-400 mb-2">Informasi Customer & Admin
          </h3>
        ...
        <!-- Order Info -->
        <div class="p-4 bg-white dark:bg-secondary-800 rounded-xl shadow-sm">
          <h3 class="text-sm font-medium text-secondary-500 dark:text-secondary-400 mb-2">Informasi Return Penjualan
          </h3>
          <div class="grid grid-cols-2 gap-2 text-sm">
            <div class="text-secondary-500 dark:text-secondary-400">Nota Penjualan : </div>
            <div>
              {{ data?.nota }}
            </div>
            <div class="text-secondary-500 dark:text-secondary-400">Tanggal Return Penjualan:</div>
