<template>
  <BasePage title="Suppliers" subtitle="Manage your product suppliers">
    <template #actions>
      <button type="button" @click="supplierStore.setShowSupplierForm(true)"
    ...
    <template #search>
      <div class="relative rounded-md shadow-sm">
        ...
        <BaseInput v-model="supplierStore.params.q" placeholder="Search suppliers..." type="text" class="w-full"
          clearable :debounce="500" @clear="supplierStore.params.q = ''"
    ...
    <DataTable :supplier-store="supplierStore" @edit-supplier="editSupplier" @delete-supplier="deleteSupplier" />

    <BasePagination v-if="supplierStore.paginationInfo.totalItems > 0"
      v-model:current-page="supplierStore.pagination.page" :total-items="supplierStore.paginationInfo.totalItems"
      :items-per-page="supplierStore.pagination.itemsPerPage" @update:current-page="supplierStore.handlePageChange" />


    <!-- Supplier Form Modal -->
    <SupplierForm v-if="showSupplierForm" v-model="showSupplierForm" :supplier="selectedSupplier"
      :is-edit="!!selectedSupplier" @close="handleClose" @submit="handleSubmit" />

    <!-- Delete Confirmation Modal -->
    <Modal v-model="showDeleteModal" title="Delete Supplier" @close="showDeleteModal = false">
      <div class="mt-2">
        <p class="text-sm text-gray-500 dark:text-gray-400">Are you sure you want to delete this supplier? This action
          cannot be undone.</p>
      </div>
      <template #footer>
