<template>
  <BaseDialog title="Edit Data Pengguna" max-width="xl" @close="closeDialog" @show="init">
        ...
        <div class="space-y-4">
          ...
          <form @submit.prevent="submit">
            ...
            <div class="mt-4 py-4 border-t border-gray-50">
              ...
              <base-button type="submit" label="Perbarui Data" :loading="storeForm.loading" class="ml-2"></base-button>
            </div>
          </form>
...
function init() {
  form.value = {
    id: storeForm.item.id,
    name: storeForm.item.name,
    username: storeForm.item.username,
    email: storeForm.item.email,
    password: null,
    password_confirmation: null,
    role: storeForm.item.role,
  }
}
...
const submit = () => {
  ...
  storeForm.updateData(form.value)
}
