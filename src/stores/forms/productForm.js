    ...
    resetForm() {
      ...
      if (!editing) {
        ...
        this.formData = {
          ...
          hargajualrumah: selectedProduct.hargajualrumah ? parseFloat(selectedProduct.hargajualrumah) : 0,
          hargajualtoko: selectedProduct.hargajualtoko ? parseFloat(selectedProduct.hargajualtoko) : 0,
          hargajualdepot: selectedProduct.hargajualdepot ? parseFloat(selectedProduct.hargajualdepot) : 0,
          hargajualkhusus: selectedProduct.hargajualkhusus ? parseFloat(selectedProduct.hargajualkhusus) : 0,
